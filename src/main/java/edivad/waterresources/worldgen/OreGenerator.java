...
import edivad.waterresources.config.OregenConfig;
...
public class OreGenerator implements IWorldGenerator {
	...
	public static final String RETRO_NAME = "WaterResourcesOreGen";
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, boolean newGen)
	{
		...
		if(world.provider.getDimension() == DimensionType.OVERWORLD.getId())
		{
			...
			{
				addOreSpawn(ModBlocks.GOLDFIELD_ORE, (byte) OreType.ORE_OVERWORLD.ordinal(), Blocks.STONE, world, random, chunkX * 16, chunkZ * 16, OregenConfig.MIN_VEIN_SIZE, OregenConfig.MAX_VEIN_SIZE, OregenConfig.CHANCES_TO_SPAWN, OregenConfig.MIN_Y, OregenConfig.MAX_Y);
			}
		}
