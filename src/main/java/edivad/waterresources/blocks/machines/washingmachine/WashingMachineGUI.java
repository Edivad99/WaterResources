...
public class WashingMachineGUI extends GuiContainer {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Main.MODID + ":textures/gui/washing_machine.png");
	private final TileEntityWashingMachine tileEntity;

	public WashingMachineGUI(TileEntityWashingMachine tileEntity, WashingMachineContainer container)
	{
		super(container);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		if(mouseX > guiLeft + 35 && mouseX < guiLeft + 57 && mouseY > guiTop + 10 && mouseY < guiTop + 77)
			drawHoveringText(Collections.singletonList("Distilled water: " + this.tileEntity.getClientFluidWaterAmount() + " mB"), mouseX, mouseY, fontRenderer);
		if(mouseX > guiLeft + 63 && mouseX < guiLeft + 85 && mouseY > guiTop + 10 && mouseY < guiTop + 77)
			drawHoveringText(Collections.singletonList("Auriferous water: " + this.tileEntity.getClientFluidAUAmount() + " mB"), mouseX, mouseY, fontRenderer);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		int z = this.getFluidScaled(60, this.tileEntity.getClientFluidWaterAmount());
		...
		int z1 = this.getFluidScaled(60, this.tileEntity.getClientFluidAUAmount());
		fluidTexture = mc.getTextureMapBlocks().getTextureExtry(ModLiquids.auriferous_water.getStill().toString());
		this.drawTexturedModalRect(this.guiLeft + 66, this.guiTop + 12 + z1, fluidTexture, 16, 60 - z1);
	}
	...
	{
		int maxLiquidAmount = WashingMachine.TANK_CAPACITY;
