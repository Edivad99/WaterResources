...
public class WaterCoolingContainer extends Container implements IMachineStateContainer {

	private final TileEntityWaterCooling tileEntity;

	public WaterCoolingContainer(IInventory playerInventory, TileEntityWaterCooling tileEntity)
	{
	...
	private void addOwnSlots()
	{
		...
		addSlotToContainer(new SlotItemHandler(itemHandler, 0, 89, 15));
	}
			...
			if(tileEntity.getProgress() != tileEntity.getClientProgress() || tileEntity.getEnergy() != tileEntity.getClientEnergy() || tileEntity.getFluidInAmount() != tileEntity.getClientFluidInAmount() || tileEntity.getFluidOutAmount() != tileEntity.getClientFluidOutAmount())
			{
				...
				for(IContainerListener listener : listeners)
				{
					if(listener instanceof EntityPlayerMP)
					{
						...
						int percent = 100 - tileEntity.getProgress() * 100 / WaterCoolingConfig.MAX_PROGRESS;
